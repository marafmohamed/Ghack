...
classification_role = "I have a big company that receives many mails, i want you to categorize these mails and to redirect them to their departements, i'm gonna be giving you a mail and it's departements and i want you to understand the mail then classifying it into one of these departements: "
classification_sub_role = " your answer should be in one word only no more, here is the mail classify it for me to one of the classes mentioned before "

summarization_role = "i want you to summarize this mail for my company, keep only the most important content, and be aware it's so important to make it as much summarized as is possible without losing any important informations"

spam_detection_role = "You are my Gmail 'Spam mails' detector, i'll provide you a mail and i want you to return to me one word (true or false) wether this mail is a spaming mail or not"


respond_role = "you are my Email responder responsible, i want you to generate for me a respond for this mail and make it small and clear, don't add any masks like this([YOUR NAME]) or masks like this fill all the gaps please,"